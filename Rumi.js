    ...
    <div>
      <div className="svgouterdiv">
        ...
        <svg id='svgidtop' xmlns="http://www.w3.org/2000/svg" viewBox="0 -18 763.03 100">
            ...
            <path id="topcurve" d="M.49 44.55S9.49.08 71.64.5c78.22.53 181.57 82.07 276.14 44.05 212.8-85.56 415.06-5.09 415.06-5.09"  fill="none"  stroke-miterlimit="10"/>

            
            
            <text className='svgtext' fill-opacity='0' fill='#b33434'>
        ...
        <svg id="svgidbottom" xmlns="http://www.w3.org/2000/svg" viewBox="0 4 946 70"><path id='bottomcurve' d="M.47 2.41s20.43 55.91 143 52.52 234-66.07 328.72-52.52 341.73 88 473.59 25.38" fill="none" stroke-miterlimit="10"/>
            ...
            <text className='svgtext' fill-opacity='0' fill='#b33434'>
                ...
                <animate attributeName="fill" dur="3s" repeatCount="1" from="rgb(213, 180, 208)" to="rgb(255, 0, 0) "fill='freeze'/>
            </text>
